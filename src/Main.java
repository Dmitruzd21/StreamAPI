...
public class Main {
    public static void main(String[] args) {
        ...
        long countOfUnderAgePersons = persons.stream()
                .filter(person -> person.getAge() < 18)
                .count();
        System.out.println("Количество несовершеннолетних: " + countOfUnderAgePersons);
        ...
        List<Person> workablePersons = persons.stream()
                ...
                .filter(person -> person.getSex() == Sex.MAN || (person.getSex() == Sex.WOMAN && person.getAge() <= 60))
